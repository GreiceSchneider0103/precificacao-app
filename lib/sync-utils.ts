...
export async function saveSettings(activeRuleId: string, ruleSets: any[]) {
...
export async function deleteProduct(sku: string) {
  const response = await fetch(`/api/products-db?sku=${encodeURIComponent(sku)}`, {
    method: "DELETE",
  });
...
export async function savePromotions(promotions: any[]) {
...
export async function loadPromotions(activeOnly = false) {
  try {
...
export async function loadHistory(limit = 100, channel?: string) {
  try {
